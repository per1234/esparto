...
It supports the "event-driven" style that allows the ESP8266 to function at its best and relies on "callbacks" to nofify you when your code should be run. Each of these topics is a subject in itself (more information can be found here and here)- suffice to say that you will get far less errors, far less frustration and much shorter development times using *Esparto*.

Esparto does a lot of the ESP8266 "heavy lifting" for you and allows you to concentrate on just the code that your specific hardware needs.
